...
@GroupSequence({ CreateUserReq.class, CreateUserReq.Check1.class, CreateUserReq.Check2.class }) // Check order,
                                                                                                // if check1
                                                                                                // fails, there
                                                                                                // is no need
                                                                                                // to check
...
public class RoleReq {
    ...
    public RoleReq(String roleName, Integer isActive, Set<Long> permissionIds) {
